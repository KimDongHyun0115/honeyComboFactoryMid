...
@WebServlet("/FindPasswordAndUpdatePasswordServlet")
public class FindPasswordAndUpdatePasswordServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	public FindPasswordAndUpdatePasswordServlet() {
		super();
	}
