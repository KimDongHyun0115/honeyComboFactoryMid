...
@WebServlet("/GsHotIssueProductServlet")
public class GsHotIssueProductServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	public GsHotIssueProductServlet() {
		super();
	}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		int hotGSProductPageNumber = Integer.parseInt(request.getParameter("hotGSProductPageNumber"));
		int hotGSProductContentCount = Integer.parseInt(request.getParameter("hotGSProductContentCount"));

		System.out.println("더보기 횟수 [" + hotGSProductPageNumber + "]");
		System.out.println("보여줄 데이터 수 [" + hotGSProductContentCount + "]");

		// 시작 인덱스
		int startIndex = (hotGSProductPageNumber - 1) * hotGSProductContentCount;
		...
		productSingleDTO.setLimitNumber(hotGSProductContentCount);
