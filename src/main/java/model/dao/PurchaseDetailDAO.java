...
public class PurchaseDetailDAO {
	...
	public ArrayList<PurchaseDetailDTO> selectAll(PurchaseDetailDTO purchaseDetailDTO){
		...
		try {
			...
			pstmt.setLong(1, purchaseDetailDTO.getMemberNumber());
			pstmt.setLong(2, purchaseDetailDTO.getPurchaseNumber());
			System.out.println("회원번호 확인 ["+purchaseDetailDTO.getMemberNumber()+"]");
			System.out.println("주문 상세 번호 입력 [" + purchaseDetailDTO.getPurchaseNumber()+"]");
			System.out.println("DTO 디버깅: " + purchaseDetailDTO);
			ResultSet rs = pstmt.executeQuery();
			System.out.println("주문 상세 정보 불러오기");

			while(rs.next()) {
				PurchaseDetailDTO data = new PurchaseDetailDTO();
				...
				data.setMemberNumber(purchaseDetailDTO.getMemberNumber());
			    data.setPurchaseNumber(purchaseDetailDTO.getPurchaseNumber());
	...
	public boolean insert(PurchaseDetailDTO purchaseDetailDTO) {
		...
		try {
			...
			pstmt.setLong(1, purchaseDetailDTO.getPurchaseDetailNumber());	// 주문 상세 번호
	        pstmt.setLong(2, purchaseDetailDTO.getPurchaseProductCount());	// 수량
	        pstmt.setLong(3, purchaseDetailDTO.getProductSingleNumber());	// 개별 상품 번호
	        pstmt.setLong(4, purchaseDetailDTO.getProductComboNumber());	// 조합 상품 번호
	        pstmt.setLong(5, purchaseDetailDTO.getPurchaseNumber());	// 주문 번호
	        
	        System.out.println(">> PURCHASE_DETAIL_NUMBER: " + purchaseDetailDTO.getPurchaseDetailNumber());
			System.out.println(">> PURCHASE_PRODUCT_COUNT: " + purchaseDetailDTO.getPurchaseProductCount());
			System.out.println(">> PRODUCT_SINGLE_NUMBER: " + purchaseDetailDTO.getProductSingleNumber());
			System.out.println(">> PRODUCT_COMBO_NUMBER: " + purchaseDetailDTO.getProductComboNumber());
			System.out.println(">> PURCHASE_NUMBER: " + purchaseDetailDTO.getPurchaseNumber());
