...
<!-- 사용자 정의 css -->
<link href="assets/css/customization/board.css" type="text/css" rel="stylesheet">
						...
						<div class="row justify-content-between align-items-center">
							<div class="col-xl-8 col-lg-8 col-md-8 col-sm-8">
								<div class="hero__caption">
									<h1 data-animation="fadeInLeft" data-delay=".4s"
										data-duration="2000ms">MD 강.력.추.천 꿀조합!</h1>
							...
							<div
								...
								<div class="hero__img" data-animation="bounceIn"
									data-delay=".4s">
									<img src="${MDRecommendProductData.productComboImage}" alt="MD추천 꿀조합 상품"
										class="heartbeat">
								</div>
							</div>
						</div>
						...
						<div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
							<div class="single-popular-items mb-50 text-center">
								<div class="popular-img">
									...
									<div class="img-cap"
										onclick="insertCart(${allStoreProductCombo.productComboNumber},1,true)">
										<span>장바구니 담기</span>
									</div>
								</div>
								<div class="popular-caption">
									...
									<span>${allStoreProductCombo.productComboPrice}</span>
								</div>
							</div>
						</div>
					</c:forEach>
						...
						<div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
							<div class="single-popular-items mb-50 text-center">
								<div class="popular-img">
									...
									<div class="img-cap"
										onclick="insertCart(${CUStoreProductCombo.productComboNumber},1,true)">
										<span>장바구니 담기</span>
									</div>
								</div>
								<div class="popular-caption">
									...
									<span>${CUStoreProductCombo.productComboPrice}</span>
								</div>
							</div>
						</div>
					</c:forEach>
						...
						<div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
							<div class="single-popular-items mb-50 text-center">
								<div class="popular-img">
									...
									<div class="img-cap"
										onclick="insertCart(${GSStoreProductCombo.productComboNumber},1,true)">
										<span>장바구니 담기</span>
									</div>
								</div>
								<div class="popular-caption">
									...
									<span>${GSStoreProductCombo.productComboPrice}</span>
								</div>
							</div>
						</div>
					</c:forEach>
				...
				<table id="boardTable">
					...
					<tbody>
						<c:forEach var="boardComboPopular" items="${boardComboPopularTop}">
							<tr onclick="location.href='boardDetail.do?boardComboNumber=${boardComboPopular.boardComboNumber}'">
