				...
				<div class="row justify-content-center">
						...
						<div class="single_product_text text-center">
							...
							<div class="card_area">
								<div class="product_count_area">
									<p>재고 : ${productData.productStock}</p>
					...
					<div class="comment-form">
						<aside class="single_sidebar_widget popular_post_widget">
							<c:if
								test="${not empty productComboComponentDatas}">
								...
								<div class="media post_item">
									<ul class="instagram_row flex-wrap">
										<c:forEach var="productComboComponentData"
											...
											<li><a
												href="productDetail.do?productSingleNumber=${productComboComponentData.productSingleNumber}">
													<img class="img-fluid"
						...
						<div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
							<div class="single-popular-items mb-50 text-center">
								...
								<div class="popular-caption">
									...
									<span>${recommendProductData.productSinglePrice}원</span>
								</div>
							</div>
						</div>
					</c:forEach>
